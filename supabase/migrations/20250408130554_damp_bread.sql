/*
  ...
  - Allow public to create vacation requests
*/
...
DROP POLICY IF EXISTS "Anyone can view requests" ON vacation_requests;
DROP POLICY IF EXISTS "Authenticated users can create requests" ON vacation_requests;
