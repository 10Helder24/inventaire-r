...
export function PublicView({ articles, loading }: PublicViewProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="sm:hidden flex items-center gap-2 px-4 py-2 bg-green-700 hover:bg-green-800 rounded-md transition-colors"
              >
            ...
            <div className="flex-1 flex flex-col sm:flex-row gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => navigate('/login')}
                  className="hidden sm:flex items-center gap-2 px-4 py-2 bg-green-700 hover:bg-green-800 rounded-md transition-colors"
                >
                  <LogIn className="h-5 w-5" />
                  <span>Connexion</span>
                </button>
      ...
      <main className="container mx-auto px-4 pt-32 sm:pt-24 pb-6">
